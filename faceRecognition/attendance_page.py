...
if __name__ == "__main__":
    ...
    def single():
        os.system("python attendance_gui.py")
    def double():
        os.system("python attendance_gui_1.py")
    def destroy_win():
        root.destroy()
    ...
    # 创建退出button
    Button(root, text="退出考勤界面", font=('times new roman', 20), bg="maroon", fg="white", command=destroy_win).grid(row=9,columnspan=2,sticky=N + E + W + S, padx=10, pady=10)
